...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_theme_file_uri('/assets/bootstrap/css/bootstrap.css') ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo get_theme_file_uri('/assets/css/bootstrap-select.min.css') ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo get_theme_file_uri('/assets/css/jquery.slider.min.css') ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo get_theme_file_uri('/assets/css/owl.carousel.css') ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo get_theme_file_uri('/assets/css/owl.transitions.css') ?>" type="text/css">
            ...
            <div class="container">
                ...
                <div class="user-area">
                    ...
                    <div class="language-bar">
                        <a href="#" class="active"><img src="<?php echo get_theme_file_uri('/assets/img/flags/gb.png') ?>" alt=""></a>
                        <a href="#"><img src="<?php echo get_theme_file_uri('/assets/img/flags/de.png') ?>" alt=""></a>
                        <a href="#"><img src="<?php echo get_theme_file_uri('/assets/img/flags/es.png') ?>" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <header class="navbar" id="top" role="banner">
                <div class="navbar-header">
                    ...
                    <div class="navbar-brand nav" id="brand">
                        <a href="index-google-map-fullscreen.html"><img src="<?php echo get_theme_file_uri('/assets/img/logo.png') ?>" alt="brand"></a>
                    </div>
                </div>
    ...
    <div id="slider" class="loading has-parallax">
        ...
        <div class="owl-carousel homepage-slider carousel-full-width">
            <div class="slide">
                ...
                <img alt="" src="http://themestarz.net/html/zoner/assets/img/slide-01.jpg">
            </div>
            <div class="slide">
                <div class="container">
                    <div class="overlay">
                ...
                <img alt="" src="http://themestarz.net/html/zoner/assets/img/slide-02.jpg">
            </div>
            <div class="slide">
                <div class="container">
                    <div class="overlay">
                ...
                <img alt="" src="http://themestarz.net/html/zoner/assets/img/slide-03.jpg">
            </div>
        </div>
    </div>
    <!-- end Slider -->
...
<script type="text/javascript" src="<?php echo get_theme_file_uri('/assets/js/jquery-2.1.0.min.js') ?>"></script>
<script type="text/javascript" src="<?php echo get_theme_file_uri('/assets/js/jquery-migrate-1.2.1.min.js') ?>"></script>
<script type="text/javascript" src="<?php echo get_theme_file_uri('/assets/bootstrap/js/bootstrap.min.js') ?>"></script>
<script type="text/javascript" src="<?php echo get_theme_file_uri('/assets/js/smoothscroll.js') ?>"></script>
<script type="text/javascript" src="<?php echo get_theme_file_uri('/assets/js/owl.carousel.min.js') ?>"></script>
<script type="text/javascript" src="<?php echo get_theme_file_uri('/assets/js/bootstrap-select.min.js') ?>"></script>
<script type="text/javascript" src="<?php echo get_theme_file_uri('/assets/js/jquery.validate.min.js') ?>"></script>
<script type="text/javascript" src="<?php echo get_theme_file_uri('/assets/js/jquery.placeholder.js') ?>"></script>
<script type="text/javascript" src="<?php echo get_theme_file_uri('/assets/js/icheck.min.js') ?>"></script>
<script type="text/javascript" src="<?php echo get_theme_file_uri('/assets/js/jquery.vanillabox-0.1.5.min.js') ?>"></script>
<script type="text/javascript" src="<?php echo get_theme_file_uri('/assets/js/retina-1.1.0.min.js') ?>"></script>
<script type="text/javascript" src="<?php echo get_theme_file_uri('/assets/js/custom.js') ?>"></script>
<!--[if gt IE 8]>
